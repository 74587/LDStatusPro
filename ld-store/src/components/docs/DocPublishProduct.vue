<template>
  <div class="doc-content">
    ...
    <p>选择“自动发卡”，再选择独立卡密或共享卡密。独立卡密逐条发放；共享卡密重复发放同一内容、固定每位用户累计限购一件，商城库存显示 9999。</p>
    ...
    <p>普通物品和独立卡密可以选择不限制、每笔订单最多 X 件，或每位用户在该物品生命周期内累计最多 X 件。共享卡密由系统固定为每位用户累计一件。</p>
    <ul>
      <li>“每笔订单最多”只限制当前订单，买家之后仍可再次下单。</li>
      <li>“每位用户累计最多”会统计该账号已购买数量，待支付订单会暂时占用额度。</li>
      <li>取消或过期会释放暂占额度；支付成功后永久计入，即使退款也不会恢复。</li>
