<template>
  <div class="doc-content">
    ...
    <ul>
      ...
      <li>每位买家每次下单限购一件，避免同一订单重复获得相同内容。</li>
    ...
    <p>独立卡密与共享卡密之间可以切换，但会涉及库存暂停、恢复或迁移，并重新进入审核流程。操作前先阅读 <router-link to="/docs/inventory-management#switch-cdk-mode">切换卡密模式</router-link>，避免误解库存变化。</p>
