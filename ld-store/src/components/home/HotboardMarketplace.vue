...
@media (prefers-reduced-motion: reduce) { .section-content { animation: none; }.hotboard-seller-item, .hotboard-cat-bar-fill { transition: none; } }
</style>
