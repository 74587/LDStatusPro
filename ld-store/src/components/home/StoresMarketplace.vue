...
.tag-subscription { background: #e2e8df; color: #6d7f6d; }.tag-service { background: #dde2ea; color: #5f6f80; }.tag-vps { background: #e8e2d8; color: #7d7060; }.tag-ai { background: #e3dfe8; color: #706480; }.tag-entertainment { background: #e8dee0; color: #806068; }.tag-charity { background: #e5dde3; color: #706070; }
.tag-remove { display: inline-grid; place-items: center; width: 14px; height: 14px; border-radius: 50%; background: rgba(0, 0, 0, .2); color: #fff; font-size: 10px; }
