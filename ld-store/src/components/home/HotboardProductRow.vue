...
.rank-badge { width: 26px; height: 26px; display: grid; place-items: center; border-radius: 8px; background: var(--bg-tertiary); color: var(--text-tertiary); font-size: 13px; font-weight: 700; flex-shrink: 0; }.rank-1 { background: linear-gradient(135deg, #ffd700, #ffb800); color: #5a4000; }.rank-2 { background: linear-gradient(135deg, #d1d5db, #b0b5bc); color: #3a3a3a; }.rank-3 { background: linear-gradient(135deg, #e8a860, #cd7f32); color: #fff; }
...
@media (prefers-reduced-motion: reduce) { .hotboard-product-item { transition: none; } }
</style>
