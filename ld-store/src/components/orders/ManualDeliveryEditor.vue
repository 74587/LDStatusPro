...
.action-btn.pay-btn { color: white; background: linear-gradient(135deg, var(--color-primary), var(--color-primary-hover)); }
...
.seller-row-primary { color: #fff; background: var(--seller-navy); border-color: var(--seller-navy); }
