...
.home-banner::before { content: ''; position: absolute; inset: 0 0 auto; height: 50%; border-radius: 24px 24px 50% 50%; background: linear-gradient(180deg, var(--glass-shine), rgba(255, 255, 255, .05) 60%, transparent); pointer-events: none; }
