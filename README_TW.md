...
- **兌換資訊中心** - 虛擬物品和服務兌換平台
- **CDK 自動發放** - 兌換成功後自動取得卡密
- **分類瀏覽** - AI/儲存/小雞/諮詢/訂閱/接碼/服務/小店
- **訂單追蹤** - 查看兌換記錄和狀態
- **商家進駐** - 綁定 LDC 帳戶發佈兌換資訊
...
- ✨ **等級徽章動效** - 懸浮 360° 翻轉 + 漸變流動
- 🌈 **等級專屬配色** - Lv1 灰/Lv2 藍/Lv3 紫青/Lv4 金橙紅
- 🎨 **玻璃擬態設計** - 毛玻璃效果 + 發光邊框
...
- **客戶端**: 原生 JavaScript，零依賴，16000+ 行程式碼
...
- 💳 **LDC 積分兌換** - 使用 LDC 積分兌換虛擬物品和服務
- 📦 **CDK 自動發放** - 兌換成功後自動取得卡密，支援一鍵複製
- 👤 **商家進駐** - 綁定 LDC 帳戶發佈兌換資訊
- 📋 **訂單追蹤** - 查看兌換記錄和狀態
- 🔑 **CDK 管理** - 商家可批次新增、查看、複製 CDK

**🛡️ 安全加固**

- 🔒 XSS 防護增強 - 修復彈窗對話框中商品名稱未轉義的風險
- 🔐 CDK 競態修復 - 使用原子 UPDATE 操作解決高並發超賣問題
- 💉 SQL 注入防護 - 統一使用參數化查詢

**🎨 UI/UX 最佳化**

- 🖼️ 詳情頁最佳化 - 圖片 16:9 比例，描述區高度增加
- 📜 列表捲動記憶 - 返回列表時恢復捲動位置
- ⚠️ 拒絕/下架原因顯示 - 我的發佈中顯示拒絕或下架原因

---

### v3.5.2.x 🔑 CDK 面板 & 請求最佳化
...
- 🚦 全域請求佇列 - 300ms 最小間隔防止 429
- ⏱️ 429 限流冷卻 - 2 分鐘內不再發起新請求
- 💬 錯誤提示最佳化 - 智慧識別錯誤類型，友善提示
...
<details>
<summary><b>🏪 如何在 LD士多發佈兌換資訊？</b></summary>

1. 開啟 LDC 積分面板，切換到「LD 士多」標籤
2. 點擊「我的發佈」→「商家設定」
3. 填寫 LDC PID（從 credit.linux.do 個人頁面取得）
4. 設定通知網址（可選，用於接收訂單回呼）
5. 儲存後即可開始發佈兌換資訊
</details>
